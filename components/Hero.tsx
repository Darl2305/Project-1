      ...
      <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        <div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text-primary)] leading-tight mb-6">
            Convierto datos complejos en decisiones accionables.
          </h1>
          <p className="text-lg text-[var(--text-secondary)] mb-8 max-w-xl">
            Construyo proyectos de machine learning y analítica que son medibles, reproducibles y fáciles de explicar.
          </p>
          <a
            href="#contacts"
